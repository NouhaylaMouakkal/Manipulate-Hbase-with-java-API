...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            put.addColumn(Bytes.toBytes(CF_PERSONAL_DATA), Bytes.toBytes("name"), Bytes.toBytes("John Doe"));
            put.addColumn(Bytes.toBytes(CF_PERSONAL_DATA), Bytes.toBytes("age"), Bytes.toBytes("23"));
            put.addColumn(Bytes.toBytes(CF_PRO_DATA), Bytes.toBytes("grades"), Bytes.toBytes("math A+, science A"));
            table.put(put);
